...
const MAX_TRIAL_REPORT_BYTES = 4 * 1024 * 1024;
const MAX_PROVENANCE_MANIFEST_BYTES = 64 * 1024 * 1024;
...
const NUMERIC_LOGISTIC_REGRESSION_LOGICAL_PATH =
  "training/study-runner/numeric_logistic_regression.py";
const NUMERIC_LOGISTIC_REGRESSION_RUNNER_VERSION = 2;
...
const probabilityMetricSchema = z.number().finite().min(0).max(1);
...
const studyModelReferenceSchema: z.ZodType<StudyModelReference> = z.object({
